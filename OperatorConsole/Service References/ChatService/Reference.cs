...
namespace OperatorConsole.ChatService {
    ...
    public interface IChatService {
        ...
        string RequestChat(OperatorConsole.ChatService.ChatRequestEntity request);
        ...
        void WriteMessage(OperatorConsole.ChatService.MessageEntity msg);
        ...
        OperatorConsole.ChatService.MessageEntity[] GetMessages(string channelId, long lastId);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public interface IChatServiceChannel : OperatorConsole.ChatService.IChatService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public partial class ChatServiceClient : System.ServiceModel.ClientBase<OperatorConsole.ChatService.IChatService>, OperatorConsole.ChatService.IChatService {
        ...
        public string RequestChat(OperatorConsole.ChatService.ChatRequestEntity request) {
            return base.Channel.RequestChat(request);
        }
        
        public void WriteMessage(OperatorConsole.ChatService.MessageEntity msg) {
            base.Channel.WriteMessage(msg);
        }
        
        public OperatorConsole.ChatService.MessageEntity[] GetMessages(string channelId, long lastId) {
