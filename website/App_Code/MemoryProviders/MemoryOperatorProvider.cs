...
public class MemoryOperatorProvider : OperatorProvider
{
	...
	{
		OperatorInfo op = new OperatorInfo(1, opName, opPassword, opEmail, false, "support");
	...
	public override List<ChatRequestInfo> GetChatRequest(int operatorId, string[] departments)
	{
		...
		return results;*/
        return ChatService.GetRequests(-1, null);
	}
